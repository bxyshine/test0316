...
<input type="text" id="search_input" name = "kd"  tabindex="1" value="<?=$search; ?>"  placeholder="请输入职位名称，如：产品经理"  />
...
<div class="hot_pos_l">
<div class="mb10">
<a href="h/jobs/86989.html" title="<?=$v['positionName']; ?>" target="_blank"><?=$v['positionName']; ?></a> 
&nbsp;
<span class="c9">[<?=$v['positionAddress']; ?>]</span>
</div>
<span><em class="c7">月薪：</em><?=$v['salaryMin']; ?></span>
<span><em class="c7">经验：</em><?=$v['workYear']; ?></span>
<span><em class="c7">最低学历： </em><?=$v['education']; ?></span>
<br />
<span><em class="c7">职位诱惑：</em><?=$v['positionAdvantage']; ?></span>
<br />
<span><?=substr($v['time'],0,10); ?>日发布</span>
</div> 
<div class="hot_pos_r">
<div class="apply">
<a href="<?php echo Url::to(['work/deliver']); ?>" target="_blank">投个简历</a>
</div>
<div class="mb10"><a href="h/c/1712.html" title="<?=$v['company']['abbreviation'] ?>" target="_blank"><?=$v['company']['abbreviation'] ?></a></div>
<span><em class="c7">领域： </em><?=$v['company']['domain_id'] ?></span>
<span><em class="c7">创始人：</em><?=$v['createc']['username'] ?></span>
<br />
<span><em class="c7">阶段： </em><?=$v['company']['phase_id'] ?></span>
<span><em class="c7">规模： </em><?=$v['company']['scale_id'] ?></span>
