	...
	<div id="header">
    	<div class="wrapper">
        	...
        	<dl class="collapsible_menu">
                ...
                <dd class="logout"><a rel="nofollow" href="<?=Url::to(['login/loginout'])?>">退出</a></dd>
            </dl>
    ...
    <div id="container">
            ...
            <div class="content_l">
                    ...
                    <dd class="job_request">
                    	<span class="red"><?=$data['salaryMin'] ?></span>
                       	<span><?=$data['positionAddress'] ?></span> 
                       	<span>经验<?=$data['positionAddress'] ?></span>
                       	<span><?=$data['positionAddress'] ?></span> 
                       	<span><?=$data['jobNature'] ?></span><br>
                      	  职位诱惑 : <?=$data['positionAdvantage'] ?>
                      	<div>发布时间：<?php  
                      		if (date('Y-m-d') == substr($data['time'],0,10)) {
                      			echo substr($data['time'],0,10);
                      		}else{
                      			echo  $data['time'];
                      		}
                      	?>发布</div>
                ...
                <dl class="job_company">
                    <dt>
                    	<a target="_blank" href="c/19607.html">
                            <img width="80" height="80" alt="<?=$data['full_name'] ?>" src="<?=$data['logo'] ?>" class="b2">
                            <div>
                                <h2 class="fl">
                                	                                  		<?=$data['abbreviation'] ?>
                    ...
                    <dd>
                    	<ul class="c_feature reset">
                        	<li><span>领域</span> <?=$data['domain_id'] ?></li>
                        	<li><span>规模</span> <?=$data['scale_id'] ?></li>
                        	<li>
                        		<span>主页</span> 
                        		           							<a rel="nofollow" title="<?=$data['url'] ?>" target="_blank" href="<?=$data['url'] ?>"><?=$data['url'] ?></a>
           						                        	</li>
                        </ul>
                        
                        <h4>发展阶段</h4>
                        <ul class="c_feature reset">
                        	<li><span>目前阶段</span> <?=$data['phase_id'] ?></li>
                        	                        </ul>
