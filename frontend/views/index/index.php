...
<div id="body">
    	...
    	<div class="wrapper">
        	...
        	<ul class="loginTop">
            	<?php if(empty($userinfo)){?>
	            	<li><a href="<?php echo Url::to(['login/login']) ?>" rel="nofollow">登录</a>
					<li>|<li>
	            	<li><a href="<?php echo Url::to(['login/register']) ?>" rel="nofollow">注册</a>
            	<?php }else{ ?>
            		<li><a href="javascript:void(0)" rel="nofollow">欢迎 <?php echo $userinfo['email'] ?>登录</a>
					<li>|<li>
            		<li><a href="<?php echo Url::to(['login/loginout']) ?>" rel="nofollow">退出</a>
            	<?php } ?>
    ...
    <div id="container">
		...
		<div id="sidebar">
			...
			<?php foreach($type_tree as $key=>$value){ ?>				
		  		<div class="menu_box">
					<div class="menu_main">
						<h2><?=$value['j_name'];?><span></span></h2>

		  			<?php foreach($value['son'] as $key=>$va){ ?>
						<a href=""><?=$va['j_name'] ?></a>						
					<?php } ?>
